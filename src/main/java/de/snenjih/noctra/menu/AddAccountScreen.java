...
public class AddAccountScreen extends Screen {
    ...
    public void render(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        ctx.drawCenteredTextWithShadow(textRenderer,
                Text.translatable("noctra.add_account.title").getString(), cx, y,
    ...
    private void renderAwaiting(DrawContext ctx, int cx, int y, int panelX, int panelW,
        ...
        // Visit URL
        ctx.drawCenteredTextWithShadow(textRenderer,
                Text.translatable("noctra.add_account.visit").getString(),
        ...
        // "Enter code" label
        ctx.drawCenteredTextWithShadow(textRenderer,
                Text.translatable("noctra.add_account.code").getString(),
                cx, y, withAlpha(COL_SUBTEXT, a));
        y += 14;
        ...
        ctx.drawCenteredTextWithShadow(textRenderer,
                Text.translatable("noctra.add_account.expires_in", timerStr).getString(),
                cx, y, withAlpha(COL_SUBTEXT, a));
        y += 12;
        ...
        // Waiting hint
        ctx.drawCenteredTextWithShadow(textRenderer,
                Text.translatable("noctra.add_account.waiting").getString(),
                cx, y, withAlpha(COL_SUBTEXT, a));
    ...
    private void renderSuccess(DrawContext ctx, int cx, int y, int a) {
        ...
        ctx.drawCenteredTextWithShadow(textRenderer,
                Text.translatable("noctra.add_account.success").getString(),
    ...
    private void renderError(DrawContext ctx, int cx, int y, int panelX, int panelW,
        ...
        ctx.drawCenteredTextWithShadow(textRenderer,
                Text.translatable("noctra.add_account.retry").getString(),
    ...
    private void renderCancelBtn(DrawContext ctx, int cx, int y, int a, int mx, int my) {
        ...
        ctx.drawCenteredTextWithShadow(textRenderer,
                Text.translatable("noctra.add_account.cancel").getString(),
    ...
    private String mapError(String code) {
        ...
        return switch (code) {
            case "no_network"   -> Text.translatable("noctra.add_account.error.no_network").getString();
            case "no_license"   -> Text.translatable("noctra.add_account.error.no_license").getString();
            case "code_expired" -> Text.translatable("noctra.add_account.error.expired").getString();
            default             -> "Error: " + code;
        };
    }
