...
public class MainMenuScreen extends Screen {
    ...
    public MainMenuScreen(Screen parent) {
        super(Text.translatable("noctra.main.title"));
        this.parent = parent;
    }
    ...
    public void render(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        // Big title "NOCTRA CLIENT" — scaled 2x using Matrix3x2fStack
        float scale = 2.0f;
        ctx.getMatrices().pushMatrix();
        ctx.getMatrices().scale(scale, scale);
        int titleY = (int)((height / 2 - 60) / scale);
        ctx.drawCenteredTextWithShadow(textRenderer, "NOCTRA CLIENT",
        ...
        renderButton(ctx, btnModMenuX, btnModMenuY, btnModMenuW, btnModMenuH,
                Text.translatable("noctra.main.mod_menu").getString(), hoverMod, true);
        ...
        renderButton(ctx, btnScrX, btnScrY, btnScrW, btnScrH,
                Text.translatable("noctra.main.screenshots").getString(), hoverScr, false);
        ...
        renderButton(ctx, btnCosX, btnCosY, btnCosW, btnCosH,
                Text.translatable("noctra.main.cosmetics").getString(), hoverCos, false);
        ...
        renderButton(ctx, btnAccX, btnAccY, btnAccW, btnAccH,
                Text.translatable("noctra.main.accounts").getString(), hoverAcc, false);
